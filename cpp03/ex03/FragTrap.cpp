...
FragTrap::FragTrap(const std::string& name): ClapTrap(name) {
	std::cout << "FragTrap " << this->name_ << " Default Constructor(with name) called" << std::endl;
	this->hit_point_ = init_hp;
	this->energy_point_ = init_ep;
	this->attack_damage_ = init_ad;
}
...
FragTrap::FragTrap(const FragTrap &src) {
	std::cout << "FragTrap " << src.name_ << " Copy constructor called" << std::endl;
...
FragTrap::~FragTrap() {
	std::cout << "FragTrap " << this->name_ << "'s Destructor called" << std::endl;
}
